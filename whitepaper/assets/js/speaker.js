var data = [
	...
	{
		speakerImg: "speaker-06_huang.jpg",
		speakerName: "黃 男州",
	...
	},
	{
		...
		speakerIntro: "執行長葉福海在電子業耕耘超過 40 年，曾擔任宏碁股份有限公司副總經理及美商艾睿電子股份有限公司總經理。在他的領導下，大聯大於 2015 年開始數位轉型工程，推出以資料驅動（Data-Driven）為基礎的「大大網」，強化對上下游廠商資訊的掌握及彈性管理能力；同時提倡智能物流服務（LaaS）模式，協助客戶共同面對智慧製造的挑戰，期與產業共建大競合之生態系。<br/><br/>葉福海未來將持續推動「專注客戶、科技賦能、協同生態、共創時代」數位轉型心法，要為大聯大下一個 10 年奠定基石。",
	},
	{
...
var study = [
	...
	{
		logoImg: "logo-esun-1@3x-100.jpg",
		logoName: "玉山銀行",
		logoNameEng: "E.SUN Bank",
		logoIntro: "「心清如玉，義重如山。」1992 年，創辦人黃永仁董事長結合志同道合的專業團隊，在台灣創立以「玉山」為名的銀行，懷著「經營一家最好的銀行，舍我其誰」的使命感，建立專家領航的制度，齊心打造一家銀行家的銀行。<br/><br/>長期以來，玉山銀行不論在綜合績效、業務發展、公司治理、顧客服務、風險管理、金融創新、企業社會責任等領域皆有傑出的表現。<br/><br/>我們相信願景有多大，力量就有多大。堅持誠信正直的經營方式，建立清新專業的品牌形象，用心投入金融業的經營，善盡企業社會責任，致力成為員工、顧客及這塊土地的最愛。",
	}
];